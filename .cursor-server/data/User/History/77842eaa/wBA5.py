...
# Wallet addresses (FRESH WALLETS - Nov 11, 2025)
WALLETS: list[str] = [
    "0x17F31ed89C54Bb53111ba5597B250b4a9cFd9f70",  # New wallet 1
    "0x9b32376F962F137025FCb221b3479937E940bE5e",  # New wallet 2
    "0x9EfF5B715d0E2C0ecDacB029C742dD516A751213",  # New wallet 3
    "0xf245aCfAB1C10978A3eb507d5A57f2B2B3ebB972",  # New wallet 4
    "0xe4a8840ba281865797cfaf7Bcfc0876771285643",  # New wallet 5
    "",  "",  "",  "",  "",
    "",  "",  "",  "",  "",  "",
    "",  "",  "",  "",  "",  "",
    "",  "",
...
def get_submit_hour(now_utc: datetime.datetime) -> int:
    """Get the hour that just unlocked (current hour)"""
    # At 00:00-00:08, we claim the hour that JUST unlocked (current hour)
    return now_utc.hour
...
async def main(wallet_offset: int):
    ...
    async with aiohttp.ClientSession(connector=connector) as session:
        ...
        while True:
            ...
            # (2) Burst attack window with randomization
